...
__resources__["/ps.js"] = {meta: {mimetype: "application/javascript"}, data: function(exports, require, module, __filename, __dirname) {
...
var getMapPaths = function(svgDoc)
{
   ...
   var ret = Array.prototype.map.call(paths, function(p){return p;});
   return ret;
};
...
PS.prototype.paint = function(painter){debug.assert(false, "cannot be here");};
PS.prototype.drive = function(train, startP, prevPS){debug.assert(false, "cannot be here");};
PS.prototype.traverseDown = function(train, prevEndP, prevPS){debug.assert(false, "cannot be here");};
PS.prototype.getConnectedPS = function(){debug.assert(false, "cannot be here!")};
...
require('painter').HonestPainter.register('ps', {bbox:function(){return geo.rectMake(0, 0, 0, 0);}, draw:paintps, inside:function(){return false;}});
  ...
  svgPathEles.forEach(function(svgPathEle)
                      {
                        ...
                        if (startPstnIdx == -1)
                        {
                          ...
                          pstns.push({pstn:startPstn, svgPathEles:[]});
                        }
                        ...
                        if (endPstnIdx == -1)
                        {
                          ...
                          pstns.push({pstn:endPstn, svgPathEles:[]});
                        }
